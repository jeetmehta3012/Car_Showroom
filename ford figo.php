...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>Ford Figo  : (Rs  05.94 - 08.15 Lakh*)</h1></div>
		  				...
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/ff.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/ff-1.webp" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/ff-2.webp" alt=" " height=210px width=560px/></a>					
									<a href="#" target="_blank"><img src="images/ff-3.webp" alt=" " height=210px width=560px/></a>
						...
						<div class="grid span_2_of_3">
							<table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       ...
                                       <tr>
                                           <td>Service Cost: Rs 4,055/yr</td>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">FIGO highlights</th>
                            </tr>
                        </thead>
