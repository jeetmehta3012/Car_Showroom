...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>Toyota Yaris : (Rs  8.86 - 14.3 Lakh*)</h1></div>
		  				...
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/ty.webp" alt=" " height=200px width=500px/></a>
									<a href="#" target="_blank"><img src="images/ty-1.webp" alt=" " height=200px width=500px/></a>
									<a href="#" target="_blank"><img src="images/ty-2.webp" alt=" " height=200px width=500px/></a>					
									<a href="#" target="_blank"><img src="images/ty-3.webp" alt=" " height=200px width=500px/></a>
									
								</div>
								<ul class="pagination">
								<li><a href="#"><img src="images/ty.webp" alt=" " /></a></li>
									<li><a href="#"><img src="images/ty-1.webp" alt=" " /></a></li>
									<li><a href="#"><img src="images/ty-2.webp" alt=" " /></a></li>
									<li><a href="#"><img src="images/ty-3.webp" alt=" " /></a></li>
						...
						<div class="grid span_2_of_3">
							<table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       <tr>
                                           <td>Mileage	17.04 kmpl</td>
                                           <td>Engine	1496 cc</td>
                                       ...
                                       <tr>
                                           <td>Service Cost: Rs 3,272/yr</td>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">YARIS highlights</th>
                            </tr>
                        </thead>
