...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>Ford Aspire  : (Rs  06.09 - 08.64 Lakh*)</h1></div>
		  				...
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/fa.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/fa-1.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/fa-2.jpg" alt=" " height=210px width=560px/></a>					
									<a href="#" target="_blank"><img src="images/fa-3.jpg" alt=" " height=210px width=560px/></a>
									
								</div>
								<ul class="pagination">
									<li><a href="#"><img src="images/fa.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/fa-1.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/fa-2.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/fa-3.jpg" alt=" " /></a></li>
						...
						<div class="grid span_2_of_3">
							<table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       ...
                                       <tr>
                                           <td>Service Cost: Rs 4,515/yr</td>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">ASPIRE highlights</th>
                            </tr>
                        </thead>
