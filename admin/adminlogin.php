...
<div class="wrap"> 
	<div class="header-bot">
		 <div class="logo3">
			 <a href="index.html"><img src="images/logo3.jpg" alt="" style="margin-left: 350px;width:450px; height: 160px;"></a>
		 </div>

		<h1 style="margin-left: 500px; margin-top: 50px; color: aliceblue; font-size: 20px;"><u>ADMINISTRATOR</u></h1>
