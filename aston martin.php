		...
		<div class="main-box">
		   <div class="box_wrapper"><h1>ASTON MARTIN</h1></div>
			...
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					<img src="images/dbx.webp" alt="" style="width: 287px; height : 150px;"/>
					<div class="grid_desc">
						<p class="title">DBX</p>
					</div>
					<div class="Details">
				     <a href="am%20dbx.php" title="Lorem ipsum dolor sit amet, consect etuer" class="button">Details<span></span></a></div>
				</div>
	
               		      <div class="col_1_of_4 span_1_of_4">
					<img src="images/dbs.jpg" alt="" style="width: 287px; height : 150px;"/>
					<div class="grid_desc">
						<p class="title">DBS</p>
					</div>
					<div class="Details">
				     <a href="am%20dbs.php" title="Lorem ipsum dolor sit amet, consect etuer" class="button">Details<span></span></a></div>
				</div>

                                        <div class="col_1_of_4 span_1_of_4">
					<img src="images/amr0.jpg" alt="" style="width: 287px; height : 150px;"/>
					<div class="grid_desc">
						<p class="title">VANTAGE AMR</p>
					</div>
					<div class="Details">
				     <a href="am%20vantage amr.php" title="Lorem ipsum dolor sit amet, consect etuer" class="button">Details<span></span></a></div>
				</div>
