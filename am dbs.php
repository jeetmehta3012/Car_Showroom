...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>Aston Martin DBS superleggera : (Rs  2.32 Cr*)</h1></div>
		  				...
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/dbs.jpg"  alt=" " height=220px width=530px/></a>
									<a href="#" target="_blank"><img src="images/dbs1.jpg" alt=" " height=210px width=500px/></a>
									<a href="#" target="_blank"><img src="images/dbs2.jpg" alt=" " height=210px width=500px/></a>					
									<a href="#" target="_blank"><img src="images/dbs3.jpg" alt=" " height=210px width=500px/></a>
									
								</div>
								<ul class="pagination">
									<li><a href="#"><img src="images/dbs.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/dbs1.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/dbs2.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/dbs3.jpg" alt=" " /></a></li>
						...
						<div class="grid span_2_of_3">
							<table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       ...
                                       <tr>
                                           <td>Service Cost: Rs 95,999/yr</td>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">DBS  Superleggera highlights</th>
                            </tr>
                        </thead>
