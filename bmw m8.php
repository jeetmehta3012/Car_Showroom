...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>BMW M Series M8 Coupe : (Rs 2.15 Cr*)</h1></div>
		  				...
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/m8-1.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/m8-2.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/m8-3.jpg" alt=" " height=210px width=560px/></a>					
									<a href="#" target="_blank"><img src="images/m8-4.jpg" alt=" " height=210px width=560px/></a>
									
								</div>
								<ul class="pagination">
									<li><a href="#"><img src="images/m8-1.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/m8-2.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/m8-3.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/m8-4.jpg" alt=" " /></a></li>
						...
						<div class="grid span_2_of_3">
							<table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       <tr>
                                           <td>Mileage	6.59 kmpl</td>
                                           <td>Engine	4395 cc</td>
                                       ...
                                       <tr>
                                           <td>Service Cost: Rs 80,999 /yr</td>
                                           <td>No. of cylinders : 8</td>

                                       </tr>
                                       <tr>
                                           <td>Fuel Tank: 420L</td>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">M8 highlights</th>
                            </tr>
                        </thead>
