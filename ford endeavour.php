...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>Ford Endeavour  : (Rs  29.99 - 35.10 Lakh*)</h1></div>
		  				...
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/f-e.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/f-e-1.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/f-e-2.jpg" alt=" " height=210px width=560px/></a>					
									<a href="#" target="_blank"><img src="images/f-e-3.jpg" alt=" " height=210px width=560px/></a>
									
								</div>
								<ul class="pagination">
									<li><a href="#"><img src="images/f-e.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/f-e-1.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/f-e-2.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/f-e-3.jpg" alt=" " /></a></li>
						...
						<div class="grid span_2_of_3">
							<table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       <tr>
                                           <td>Mileage	13.9 kmpl</td>
                                           <td>Engine	1996 cc</td>
                                       ...
                                       <tr>
                                           <td>Service Cost: Rs 3,470/yr</td>
                                           <td>No. of cylinders : 4</td>

                                       </tr>
                                       <tr>
                                           <td>Fuel Tank: 80L</td>
                                           <td>No. of Gears : 10 Speed</td>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">ENDEAVOUR highlights</th>
                            </tr>
                        </thead>
...
The Ford Endeavour 2015-2020 has 2 Diesel Engine on offer. The Diesel engine is 2198 cc and 3198 cc. It is available with the transmission. Depending upon the variant and fuel type the Endeavour 2015-2020 has a mileage of 10.91 to 14.2 kmpl. The Endeavour 2015-2020 is a 7 seater SUV and has a length of 4892mm, width of 1860mm and a wheelbase of 2850mm.
