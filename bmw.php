		   ...
		   <div class="box_wrapper"><h1>BMW </h1></div>
			...
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					...
					<div class="col_1_of_4 span_1_of_4">
					<img src="images/m8-1.jpg" alt="" style="width: 287px; height : 150px;"/>
					<div class="grid_desc">
						<p class="title">M8</p>
					</div>
					<div class="Details">
				     <a href="bmw%20m8.php" title="Lorem ipsum dolor sit amet, consect etuer" class="button">Details<span></span></a></div>
				</div>
	

					<div class="col_1_of_4 span_1_of_4">
					<img src="images/z4-1.jpg" alt="" style="width: 287px; height : 150px;"/>
					<div class="grid_desc">
						<p class="title">Z4</p>
					</div>
					<div class="Details">
				     <a href="bmw%20z4.php" title="Lorem ipsum dolor sit amet, consect etuer" class="button">Details<span></span></a></div>
				</div>

	
					<div class="col_1_of_4 span_1_of_4">
					<img src="images/x7-1.jpg" alt="" style="width: 287px; height : 150px;"/>
					<div class="grid_desc">
						<p class="title">X7</p>
					</div>
					<div class="Details">
				     <a href="bmw%20x7.php" title="Lorem ipsum dolor sit amet, consect etuer" class="button">Details<span></span></a></div>
				</div>	
