...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>Ford Freestyle  : (Rs  05.99 - 08.79 Lakh*)</h1></div>
		  				...
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/f-f.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/f-f-1.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/f-f-2.jpg" alt=" " height=210px width=560px/></a>					
									<a href="#" target="_blank"><img src="images/f-f-3.jpg" alt=" " height=210px width=560px/></a>
									
								</div>
								<ul class="pagination">
									<li><a href="#"><img src="images/f-f.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/f-f-1.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/f-f-2.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/f-f-3.jpg" alt=" " /></a></li>
						...
						<div class="grid span_2_of_3">
							<table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       ...
                                       <tr>
                                           <td>Service Cost: Rs 4,817/yr</td>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">FREESTYLE highlights</th>
                            </tr>
                        </thead>
