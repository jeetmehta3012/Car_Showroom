...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>BMW X7 : (Rs 1.63 Cr*)</h1></div>
		  				...
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/x7-1.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/x7-2.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/x7-3.jpg" alt=" " height=210px width=560px/></a>					
									<a href="#" target="_blank"><img src="images/x7-4.jpg" alt=" " height=210px width=560px/></a>
									
								</div>
								<ul class="pagination">
									<li><a href="#"><img src="images/x7-1.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/x7-2.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/x7-3.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/x7-4.jpg" alt=" " /></a></li>
						...
						<div class="grid span_2_of_3">
							<table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       <tr>
                                           <td>Mileage	12.04 kmpl</td>
                                           <td>Engine	2993 cc</td>
                                       ...
                                       <tr>
                                           <td>Service Cost: Rs 15,673/yr</td>
                                           <td>No. of cylinders : 6</td>

                                       </tr>
                                       <tr>
                                           <td>Fuel Tank: 80 to 83L</td>
                            ...
                            <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       ...
                                       <tr>
                                           <td>Seating capacity: 6</td>
                                           <td>Parking Sensor : Yes</td>

                                       </tr>
                                       <tr>
                                           <td>Bootspace :212 to 326L</td>
                                           <td>Air Bag: Yes</td>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">X7 highlights</th>
                            </tr>
                        </thead>
	   ...
	   <div class="footer-top">
				...
				<div class="col_1_of_5 span_1_of_5">
					<div class="footer-grid twitts">
						...
						<p>+91 9409078145</p>
						<p>+91 7990554788</p>						                                      		<span>carshowroom@gmail.com</span>
					</div>
				</div>
				<div class="clear"></div>
		</div>
